...
#[AsEntityListener(event: Events::prePersist, method: 'prePersist', entity: WbProductSettingsModify::class)]
final class WbProductSettingsModifyListener
{
    ...
    public function prePersist(WbProductSettingsModify $data, LifecycleEventArgs $event)
    {
